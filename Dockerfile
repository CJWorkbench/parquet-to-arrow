...
RUN mkdir -p /app/src
RUN touch /app/src/csv-to-arrow.cc /app/src/parquet-diff.cc /app/src/parquet-to-arrow-slice.cc /app/src/parquet-to-text-stream.cc /app/src/parquet-to-arrow.cc /app/src/common.cc
WORKDIR /app
